...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((len(percentage_bachelors)/len(df))*100,1)
    ...
    highest_earning_country_num = high_earning_people.groupby('native-country')['salary'].count()

    total_people_country_num = df.groupby('native-country')['salary'].count()

    highest_earning_country = highest_earning_country_num .idxmax()

    highest_earning_country_percentage = (highest_earning_country_num / total_people_country_num) * 100
    ...
    more_than_50_india = people_india[people_india['salary'] == '>50K']

    occupation_counts = more_than_50_india['occupation'].value_counts()
