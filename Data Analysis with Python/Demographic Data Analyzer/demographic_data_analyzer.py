...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = (len(percentage_bachelors)/len(df))*100
    ...
    highest_earning_country_percentage = (highest_earning_country_num.max() / len(df[df['native-country'] == highest_earning_country]))*100
